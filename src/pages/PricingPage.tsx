  ...
  const pricingPlans: PricingPlan[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Profile analytics", included: true, description: "Detailed insights on profile visits and clicks" },
        { name: "Custom themes", included: true, description: "Personalize your profile appearance with premium themes" },

...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden flex flex-col" style={backgroundStyle}>
              ...
              <div className="social-scroll-container">
                <div className="social-buttons-flex">
                  ...
                  <button
                    ...
                    className="social-button bg-green-500 hover:bg-green-600 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-black hover:bg-gray-800 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-blue-700 hover:bg-blue-800 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-blue-500 hover:bg-blue-600 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-yellow-400 hover:bg-yellow-500 text-black transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-indigo-600 hover:bg-indigo-700 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="social-button bg-gray-600 hover:bg-gray-700 text-white transition-all duration-200 hover:scale-105 shadow-sm"
                  >
      ...
      <div className="relative z-10 w-full max-w-3xl lg:max-w-3xl mx-auto flex-1 flex flex-col min-h-screen py-4 sm:py-6 lg:py-10 px-2 xs:px-3 sm:px-4 lg:px-8 overflow-x-hidden">
        ...
        >
          <div className="overflow-hidden backdrop-blur-xl rounded-lg shadow-2xl relative border border-white/20" 
               style={{ 
                  ...
                  <CardContent className="space-y-3 pt-0">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {profile.phone && profile.show_phone !== false && (
                        <div className="flex items-center gap-3 p-3 rounded-lg transition-all duration-200 hover:scale-[1.02] hover:shadow-lg" style={{ background: themeColors.background + '22' }}>
                          <div className="w-10 h-10 flex-shrink-0 rounded-lg flex items-center justify-center shadow-md" style={{ background: themeColors.background }}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {profile.phone && profile.show_phone !== false && (
                        ...
                        >
                          <Button className="w-full transition-all duration-200 hover:scale-105 hover:shadow-lg" style={{ background: themeColors.background, color: "white" }}>
                      ...
                      {profile.phone && profile.show_phone !== false && profile.show_whatsapp !== false && (
                        ...
                        >
                          <Button variant="outline" className="w-full border-green-500 text-green-600 hover:bg-green-50 transition-all duration-200 hover:scale-105 hover:shadow-lg" style={{ background: themeColors.background, color: "white" }}>
...
END:VCARD`;
                        ...
                        style={{ background: themeColors.background, color: "white" }}
                      >
                  ...
                  <CardContent className="space-y-2 pt-0">
                    {mainLinks.map((link: any, idx: number) => (
                      ...
                      >
                        <Button
                          variant="outline"
                          className="w-full justify-between text-left h-auto p-2 group transition-all duration-200 hover:scale-[1.02] hover:shadow-lg bg-white/10 backdrop-blur-sm border-white/20 hover:border-white/40 hover:bg-white/20"
                          style={{ color: "white" }}
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-12 bg-white/20 group-hover:bg-white/30 rounded-lg flex items-center justify-center transition-all duration-200 group-hover:scale-110 overflow-hidden">
                              {link.thumbnail ? (
                                <img 
                                  src={link.thumbnail} 
                            ...
                            <span className="font-medium text-white" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.4)' }}>{link.platform || link.label}</span>
                          </div>
                          <ExternalLink className="w-4 h-4 opacity-50 group-hover:opacity-100 transition-all duration-200 text-white" />
                        </Button>
                      </motion.a>
                    ))}
                  </CardContent>
                      ...
                      return (
                        ...
                        >
                          {profile.social_layout_style === 'horizontal' ? (
                            ...
                            <div className="flex items-center p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:border-white/40 hover:bg-white/20 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-lg">
                              {/* Horizontal Icon Container */}
                              <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg ${platformColors.bg} ${platformColors.hover} ${platformColors.text} flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-lg flex-shrink-0 mr-3 sm:mr-4`}>
                                <Icon className="w-5 h-5 sm:w-6 sm:h-6" />
                              </div>
                              
                              {/* Horizontal Content */}
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-sm sm:text-base capitalize" style={{ color: "white", textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>
                              ...
                              <div className="flex-shrink-0 ml-3 sm:ml-4 opacity-60 group-hover:opacity-100 transition-all duration-300">
        ...
        >
          ...
          <motion.a 
            href="/" 
            className="inline-flex items-center gap-2 px-3 py-2 rounded-lg transition-all text-xs font-medium hover:scale-105 hover:shadow-lg"
            style={{ 
          ...
          >
            ...
            Join <strong>{profile?.slug || 'them'}</strong> on Scan2Tap
          </motion.a>
        </motion.div>

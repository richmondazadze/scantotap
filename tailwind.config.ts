	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				heading: ['"Link Sans Medium"', '"LinikSansBold"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				body: ['"Link Sans Medium"', '"LinikSansRegular"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				// Font weight variants
				'link-light': ['"LinikSansLight"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				'link-regular': ['"LinikSansRegular"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				'link-medium': ['"Link Sans Medium"', '"LinikSansMedium"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				'link-semibold': ['"LinikSansSemiBold"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				'link-bold': ['"LinikSansBold"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
				'link-extrabold': ['"LinikSansExtraBold"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
